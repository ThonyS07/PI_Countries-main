...
const Countries = () => {
	...
	const countriesPerPage = () => {
		return allCountries.slice((currentPage -1)*numberPerPage,((currentPage -1) * numberPerPage)+numberPerPage)
	}
	...
	return (
		...
		<div className={styles.Countries}>
			{!allCountries ? <h4 className={styles.loading}>'Loading..'</h4> : countriesPerPage().map((country) => {
				return (
					<Card
						key={country.id}
						id={country.id}
